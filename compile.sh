...
function compile {
  ...
  dart compile wasm -Ddart.vm.product=true -O2 --no-strip-wasm -o "$DIR-out/$NAME.dart2wasm.wasm" "$DIR/$NAME.dart"
  dart compile js -Ddart.vm.product=true -O4 --no-minify -o "$DIR-out/$NAME.dart2js.js" "$DIR/$NAME.dart"
  echo ""
}
