...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _169: x0 => globalThis.readFileContentsAsBytes(x0),
      _186: (c) =>
      ...
      _231: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _252: (o, p) => o[p],
      _255: x0 => globalThis.JSON.parse(x0),
      _256: x0 => x0.random(),
      _259: () => globalThis.Math,
