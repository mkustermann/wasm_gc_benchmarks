...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    List_List$filled($length, fill, $E) {
      ...
      result = J.JSArray_markFixedList(A._setArrayType(new Array($length), $E._eval$1("JSArray<0>")));
      return result;
    },
    ...
    main() {
      var result,
        t1 = new A.NonDevirtualizedListBenchmark(B.C_JsonCodec.decode$1($.$get$encoded()), "NonDevirtualizedList");
  ...
  A._JsonMap.prototype = {
    ...
    get$keys() {
      if (this._processed == null)
        return new A.LinkedHashMapKeyIterable(this._data);
  ...
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JSBool":{"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"]},"JSNumber":{"double":[]},"JSInt":{"double":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_JsonMap":{"MapBase":["String","@"],"MapBase.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"ListIterable.E":"String"},"JsonUnsupportedObjectError":{"Error":[]},"JsonCyclicError":{"Error":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"LinkedHashMapKeyIterable":1,"LinkedHashMapKeyIterator":1,"Codec":2,"Converter":2,"Iterable":1,"NonDevirtualizedListBenchmark":1}'));
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "encoded", "$get$encoded", () => B.C_JsonCodec.encode$1($.$get$arrayOfNumbers()));
  })();
